...
if LOCAL == False:
    ...
    @stub.function(
        ...
        secret=modal.Secret.from_name("id2223"),
    )
    def f():
        g()
...
def get_random_wine():
    ...
    ranges = {
        ...
        "type_3": [0, 1],
        "type_9": [0, 0],
        "fixed acidity_6": [3.8, 14.3],
        "fixed acidity_5": [4.5, 15.9],
        "fixed acidity_7": [4.2, 15.6],
        "fixed acidity_8": [3.9, 12.6],
        "fixed acidity_4": [4.6, 12.5],
        "fixed acidity_3": [4.2, 11.8],
        "fixed acidity_9": [6.6, 9.1],
        "volatile acidity_6": [0.08, 1.04],
        "volatile acidity_5": [0.1, 1.33],
        "volatile acidity_7": [0.08, 0.915],
        "volatile acidity_8": [0.12, 0.85],
        "volatile acidity_4": [0.11, 1.13],
        "volatile acidity_3": [0.17, 1.58],
        "volatile acidity_9": [0.24, 0.36],
        "citric acid_6": [0.0, 1.66],
        "citric acid_5": [0.0, 1.0],
        "citric acid_7": [0.0, 0.76],
        "citric acid_8": [0.03, 0.74],
        "citric acid_4": [0.0, 1.0],
        "citric acid_3": [0.0, 0.66],
        "citric acid_9": [0.29, 0.49],
        "residual sugar_6": [0.7, 65.8],
        "residual sugar_5": [0.6, 23.5],
        "residual sugar_7": [0.9, 19.25],
        "residual sugar_8": [0.8, 14.8],
        "residual sugar_4": [0.7, 17.55],
        "residual sugar_3": [0.7, 16.2],
        "residual sugar_9": [1.6, 10.6],
        "chlorides_6": [0.015, 0.415],
        "chlorides_5": [0.009, 0.611],
        "chlorides_7": [0.012, 0.358],
        "chlorides_8": [0.014, 0.121],
        "chlorides_4": [0.013, 0.61],
        "chlorides_3": [0.022, 0.267],
        "chlorides_9": [0.018, 0.035],
        "free sulfur dioxide_6": [1.0, 112.0],
        "free sulfur dioxide_5": [2.0, 131.0],
        "free sulfur dioxide_7": [3.0, 108.0],
        "free sulfur dioxide_8": [3.0, 105.0],
        "free sulfur dioxide_4": [3.0, 138.5],
        "free sulfur dioxide_3": [3.0, 289.0],
        "free sulfur dioxide_9": [24.0, 57.0],
        "total sulfur dioxide_6": [6.0, 294.0],
        "total sulfur dioxide_5": [6.0, 344.0],
        "total sulfur dioxide_7": [7.0, 289.0],
        "total sulfur dioxide_8": [12.0, 212.5],
        "total sulfur dioxide_4": [7.0, 272.0],
        "total sulfur dioxide_3": [9.0, 440.0],
        "total sulfur dioxide_9": [85.0, 139.0],
        "density_6": [0.98758, 1.03898],
        "density_5": [0.98722, 1.00315],
        "density_7": [0.98711, 1.0032],
        "density_8": [0.98713, 1.0006],
        "density_4": [0.9892, 1.001],
        "density_3": [0.9911, 1.0008],
        "density_9": [0.98965, 0.997],
        "pH_6": [2.72, 4.01],
        "pH_5": [2.79, 3.79],
        "pH_7": [2.84, 3.82],
        "pH_8": [2.88, 3.72],
        ...
        "pH_3": [2.87, 3.63],
        "pH_9": [3.2, 3.41],
        "sulphates_6": [0.23, 1.95],
        "sulphates_5": [0.27, 1.98],
        "sulphates_7": [0.22, 1.36],
        "sulphates_8": [0.25, 1.1],
        "sulphates_4": [0.25, 2.0],
        "sulphates_3": [0.28, 0.86],
        "sulphates_9": [0.36, 0.61],
        "alcohol_6": [8.4, 14.0],
        "alcohol_5": [8.0, 14.9],
        "alcohol_7": [8.6, 14.2],
        "alcohol_8": [8.5, 14.0],
    ...
    wine_df = generate_wine(
        random_quality,
        ["white", "red"][: ranges[f"type_{random_quality}"] + 1],
